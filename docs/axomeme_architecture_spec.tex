...
\begin{tabular}{lcccc}
\toprule
\textbf{Model / Benchmark} & \textbf{Mean AUC-ROC} & \textbf{Mean AUC-PR} & \textbf{False Positive Rate} & \textbf{Inference Speed} \\
\midrule
HyPhy MEME (Likelihood) & 0.8100 & 0.3500 & 5.0\% & ~45 seconds / gene \\
PAML CODEML (Likelihood) & 0.7800 & 0.3000 & 6.2\% & ~180 seconds / gene \\
\textbf{Axomeme 2.0 (Epoch 8 Rebalanced)} & \textbf{0.7772} & \textbf{0.2197} & \textbf{0.46\%} & \textbf{< 10 milliseconds} \\
\bottomrule
\end{tabular}
\caption{Overall benchmark metrics for Axomeme 2.0 (Epoch 8) evaluated across 17 empirical alignments from HyPhy test data.}
\end{table}
